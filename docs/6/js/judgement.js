...
class FailAny extends JudgementResult {
    ...
    unwrap() {return this.isCause ? this.#throw() : this._.value;}
    #throw() {throw new JudgementError(`失敗。`, this._.value)}
}
class FailValue extends FailAny {constructor(v){super(v)}}
class FailCause extends FailAny {constructor(v){super(v); if(!this.isCause){throw new TypeError(`vはErrorかそれを継承した型のインスタンスであるべきです。`)}}}
export {
    Judgement,
    JudgementError,
